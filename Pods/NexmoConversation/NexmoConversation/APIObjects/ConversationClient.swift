...
public class ConversationClient: NSObject {
    ...
    public var unhandledError: Observable<NetworkErrorProtocol> {
        return networkController.networkError.asObservable().skip(1).unwrap()
    }
    ...
    private override init() {
        ...
        conversation = ConversationController(network: networkController, databaseManager: databaseManager, account: account)
    ...
    private func setupAddionalBinding() {
