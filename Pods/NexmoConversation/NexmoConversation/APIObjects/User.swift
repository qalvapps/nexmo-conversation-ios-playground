...
public class User: NSObject {
    ...
    /// Not to be used
    public init(name: String) { // TODO This is currently used to fake a user. It can be removed once the server API allows querying of users.
        let data = DBUser(name: name)
        self.data = data
