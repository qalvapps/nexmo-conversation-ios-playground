...
public extension ConversationController {
    ...
    public var conversationsObjc: Array<Conversation> {
    ...
    ///   - onFailure: error
    @objc
    public func all(_ onSuccess: @escaping ([ConversationLiteModel]) -> Void, onFailure: ((Error) -> Void)?) {
        all().subscribe(
    ...
    ///   - onFailure: error
    @objc
    public func all(with userId: String, _ onSuccess: @escaping ([ConversationLiteModel]) -> Void, onFailure: ((Error) -> Void)?) {
