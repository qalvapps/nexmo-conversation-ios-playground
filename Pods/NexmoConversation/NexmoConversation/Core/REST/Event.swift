...
public class Event: NSObject {
    ...
    public required init?(conversationUuid: String?=nil, type: EventType?=nil, json: JSON) {
        self.from = "from" <~~ json
        self.to = "to" <~~ json
        ...
        guard let timestamp: Date = Decoder.decode(dateForKey: "timestamp", dateFormatter: formatter)(json) else { return nil }
