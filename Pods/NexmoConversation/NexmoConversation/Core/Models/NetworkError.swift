...
fileprivate var kJsonCodeKey: String { return "code" }
fileprivate var kJsonDescriptionKey: String { return "description" }
...
public struct NetworkError: NetworkErrorProtocol, Decodable {
    ...
    internal init?(from response: DataResponse<Any>) {
        ...
        guard let title: String = kJsonCodeKey <~~ parameters,
            let description: String = kJsonDescriptionKey <~~ parameters,
    ...
    internal init(localizedTitle: String="", localizedDescription: String="", from response: DefaultDataResponse) {
        ...
        if let data = response.data,
            ...
            let code: String = kJsonCodeKey <~~ json,
            let description: String = kJsonDescriptionKey <~~ json {
